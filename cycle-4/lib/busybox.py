...
class BusyBoxManager:
    ...
    def __init__(self, version: str, builds_dir: str, namespace_dir: str) -> None:
        ...
        self._source_dir = os.path.join(self._namespace_dir, f"busybox-{version}")
    ...
    def build_root_fs(self, root_fs_dir, rebuild) -> str:
        ...
        return os.path.join(self._namespace_dir, "initramfs.cpio")